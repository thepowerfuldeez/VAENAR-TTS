...
def _clean_word_before_phones(word):
    ...
    if len(end_symbols):
        ...
        if end_symbols[-1] == ">" and word.endswith("<pzero"):
            word = word[:-6]
            end_symbols = end_symbols[:-1] + "<pzero>"
        elif end_symbols[-1] == ">" and word.endswith("<pone"):
            word = word[:-5]
            end_symbols = end_symbols[:-1] + "<pone>"
        elif end_symbols[-1] == ">" and word.endswith("<ptwo"):
            word = word[:-5]
            end_symbols = end_symbols[:-1] + "<ptwo>"
